...
(function() {
  ...
  Game.prototype = {
     ...
     * @private
     */
    _calculateRectangleData: function(messageHeight, verticalMessageOffset) {
      var rectangleData = {
        rectangleY: 0,
        rectangleHeight: 0
      };
      ...
      if ((this.canvas.height - rectangleData.rectangleHeight) > 0) {
        rectangleData.rectangleY = 0.5 * (this.canvas.height - rectangleData.rectangleHeight);
      }
    ...
    _drawMessageInCanvas: function(msg) {
      ...
      var rectangleData = this._calculateRectangleData(messageAsArray.messageHeight, verticalMessageOffset);
